...
# Carrega variáveis de ambiente do .env antes de qualquer import da app
from dotenv import load_dotenv
load_dotenv(os.path.join(dirname(dirname(abspath(__file__))), ".env"))

# Base canônica — infrastructure models
from app.infrastructure.db.base import Base

# Importa todos os modelos para registrá-los na metadata do Base

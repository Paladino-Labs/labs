  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed inset-y-0 right-0 z-50 flex h-full w-full max-w-md flex-col gap-4 overflow-y-auto bg-popover p-6 text-sm text-popover-foreground ring-1 ring-foreground/10 shadow-xl duration-200 outline-none",
